...
public class OAIDownloader implements RFHarvesterDownloaderInterfaceV2
{
	...
	{
//		String link = URL + "?set=Encyclo&verb=ListRecords&metadataPrefix=oai_dc";
		String link = URL + "?verb=ListRecords&metadataPrefix=oai_dc"+URLADDITION;
//		String link = URL + "?verb=ListRecords&resumptionToken=57308d4c22675";
...
//							URLlist.add(URL);
//							transformation.put("URL", URLlist);
						uploader.insertRow(transformation);
						inserts++;
					}
					catch(Exception e)
